...
\huge 关系数据库管理系统OurSQL设计文档 \\ % The assignment title
\horrule{2pt} \\[0.5cm] % Thick bottom horizontal rule
}

\author{胡津铭 李天润} % Your name
...
\input{sections/section_features.tex}
\input{sections/section_algorithm.tex}
\input{sections/section_moduleinterface.tex}
\input{sections/section_grammar.tex}
\input{sections/section_files.tex}
\input{sections/section_results.tex}
\input{sections/section_division.tex}
